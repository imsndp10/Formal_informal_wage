...
Firpo, Fortin, and Lemieux (2009) introduced the use of a specific type of IF, known as recentered influence functions (RIFs), useful for analyzing how changes in the distribution of explanatory variables (X) impact the unconditional distribution of the outcome variable (Y). \parencite{Rios-Avila2020stata}
\[
RIF(y; \nu, F_Y) = \nu(F_Y) + IF(y; \nu, F_Y)
\]
